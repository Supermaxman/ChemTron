...
public class DoubleDispWindow extends JFrame implements ActionListener {
    ...
    private final JTextField i7;
    private final JTextField s7;
    private final JTextField i8;
    private final JTextField s8;
    private final JButton button;

    public DoubleDispWindow(Point point) {
        //Initialize
        ...
        i7.setPreferredSize(new Dimension(25, 25));
        s7.setPreferredSize(new Dimension(20, 20));
        i8.setPreferredSize(new Dimension(25, 25));
        s8.setPreferredSize(new Dimension(20, 20));
        ...
        this.setTitle("Double Displacement Calculator");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == button) {
        	if(i1.getText().equals("")||i2.getText().equals("")||i3.getText().equals("")||i4.getText().equals("")) {
            	...
            	label4.setText(Solver.ddiseq(i1.getText(), i2.getText(), i3.getText(), i4.getText(), s1.getText(), s2.getText(), s3.getText(), s4.getText(), i5.getText(), s5.getText(), i6.getText(), s6.getText(), i7.getText(), s7.getText(), i8.getText(), s8.getText()));
        	}
        }
    }
    }