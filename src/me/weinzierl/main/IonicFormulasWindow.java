...
public class IonicFormulasWindow extends JFrame implements ActionListener {
    ...
    public IonicFormulasWindow(Point point) {
        //Initialize
        ...
        label4.setPreferredSize(new Dimension(60, 20));
        ...
        getContentPane().setName("Ionic Formulas");
        setResizable(false);
        setLocation(point);
        
        this.setTitle("Ionic Formulas");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == button) {
        	if(i1.getText().equals("")||i2.getText().equals("")) {
            	...
            	label4.setText(Solver.ieq(i1.getText(), i2.getText()));
        	}
        }
    }
    }