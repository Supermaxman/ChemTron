...
public class MainWindow extends JFrame implements ActionListener {
    ...
    public MainWindow(Point point) {
        ...
        getContentPane().setName("Equation Calculator");
        setResizable(false);
        
        setLocation(point);
        this.setTitle("Equation Calculator");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == button1) {
        	new SynthWindow(this.getLocation());
        	ResourceManager.playSelect();
        }else if(source == button2) {
        	new DecompWindow(this.getLocation());
        	ResourceManager.playSelect();
        }else if(source == button3) {
        	new SingleDispWindow(this.getLocation());
        	ResourceManager.playSelect();
        }else if(source == button4) {
        	new DoubleDispWindow(this.getLocation());
        	ResourceManager.playSelect();
        	...
        	new MainPracticeWindow(this.getLocation());
        	this.dispose();
        	ResourceManager.playSelect();
        }
    }
