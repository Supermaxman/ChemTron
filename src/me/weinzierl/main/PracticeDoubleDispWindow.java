...
public class PracticeDoubleDispWindow extends JFrame implements ActionListener {
    ...
    public PracticeDoubleDispWindow(Point point) {
        //Initialize
        ...
        this.setTitle("Double Displacement Practice");
    ...
    public void next() {
        a = RandomGenerator.rDoubleDispEq();
        label5.setText(a.a1);
        label8.setText(a.a2);
        label6.setText(a.a3);
        label7.setText(a.a4);
