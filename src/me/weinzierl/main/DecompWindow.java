...
public class DecompWindow extends JFrame implements ActionListener {
    ...
    public DecompWindow(Point point) {
        //Initialize
        ...
        this.setTitle("Decomposition Calculator");
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (source == button) {
        	if(i1.getText().equals("")||i2.getText().equals("")||i3.getText().equals("")||i4.getText().equals("")) {
            	...
            	label4.setText(Solver.decompeq(i1.getText(), i2.getText(), s1.getText(), s2.getText(), i3.getText(), s3.getText(), i4.getText(), s4.getText()));
        	}
        }
    }
    }